...
// Fallback: specification tables (refrigerators, wine columns, etc.)
if (!cutoutW) {
  cutoutW = pickFromSpecs(specTable, [
    "cutout width",
    "cut out width"
  ]);
}
...
if (!cutoutH) {
  cutoutH = pickFromSpecs(specTable, [
    "cutout height",
    "cut out height"
  ]);
}
...
if (!cutoutD) {
  cutoutD = pickFromSpecs(specTable, [
    "cutout depth",
    "cut out depth"
  ]);
}
