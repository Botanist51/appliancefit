...
function extractOverallFromSpecsTab($) {
  ...
  for (const node of rows) {
    ...
    if (!out.height && (labelKey === "height" || labelKey.includes("overall height") || labelKey.includes("exterior height") || labelKey.includes("product height") || labelKey.includes("unit height"))) {
