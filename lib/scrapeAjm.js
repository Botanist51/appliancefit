...
if (labelKey === "minimum height") {
  minHeight = valueRaw.trim();
  continue;
}

// Maximum height
if (labelKey === "maximum height") {
  maxHeight = valueRaw.trim();
  continue;
}

// Single-value height (e.g. "Height: 34" or "Height: 34 - 36 3/8")
if (
  !out.height &&
  (
    labelKey === "height" ||
...
// If we only found minimum height, use it
if (!out.height && minHeight) {
  out.height = minHeight;
}
